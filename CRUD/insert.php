...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO wisata (namatempat, detailtempat, statuskunjung) VALUES (?, ?, ?)";
  $param = array($tempat, $detail, $status);
    ...
    <div class="card-body">
      ...
      <form action="" method="post" class="row g-3">
        <div class="col-lg-12">
          ...
          <input type="text" class="form-control" name="tempatWisata" required placeholder="Gunung Kelud">
        </div>
        <div class="col-lg-12">
          <label for="detailTempatWisata" class="form-label">Detail Tempat Wisata</label>
          <textarea class="form-control" name="detailTempatWisata" rows="3" required></textarea>
        </div>
        <div class="col-lg-12">
          <label for="statusTempatWisata" class="form-label">Status Tempat Wisata</label>
          <select class="form-select" name="statusKunjung" aria-label="statusTempatWisata" required>
